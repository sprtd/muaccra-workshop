...
mod CounterV3 {
    ...
    use intro_to_unit_testing::errors::Errors;
    ...
    impl ICounterImpl of super::ICounterV3<ContractState> {
        fn increase_count(ref self: ContractState, amount: u32) {
            ...
            assert(amount != 0, intro_to_unit_testing::errors::Errors::ZERO_AMOUNT);
            let current_count: u32 = self.count.read();
            let result = intro_to_unit_testing::addition::add_num(current_count, amount);
